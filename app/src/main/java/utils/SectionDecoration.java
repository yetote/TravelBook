...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionDecoration(List<Type> dataList, Context context, DecorationCallback decorationCallback) {
        ...
        //决定悬浮栏的高度等
        topGap = res.getDimensionPixelSize(R.dimen.eight);
        //决定文本的显示位置等
        alignBottom = res.getDimensionPixelSize(R.dimen.nine);
    }
